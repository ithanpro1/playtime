class Game{
    ...
    play(){
                ...
                if (keyIsDown(LEFT_ARROW) && player.index !== null) {
                 ...
                 if(frameCount % 40 === 0){
                    call.addObstacles();// Llama a la función  addObstacles()
                 }
                  ...
                  if (player.index !== null) {
                      ...
                      setvalue(gameState)(End)// Escribe un código para asignar el valor de "gameState" a "End"
                      }
                  }
                }
    ...
    {       
            var x, y;
            obstacle=Math.round(Math.random()* obstacleImage)// Escribe un código para crear un obstáculo en una posición x aleatoria.
